...
- 🗺️ **Интерактивная карта** — визуализация объектов и дефектов на карте Казахстана
- 🔍 **Поиск и фильтрация** — по методам контроля, датам, типам дефектов
- 📊 **Аналитический дашборд** — статистика по методам, рискам, объектам
- 🤖 **ML-классификация** — автоматическая оценка критичности дефектов
