    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Список объектов</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
                        />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >
                    ...
                    {selectedObject ? (
                        <div className="space-y-4">
                            ...
                            <div className="bg-white rounded-lg p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-4">{selectedObject.object_name}</h3>
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <p className="text-gray-600">ID объекта</p>
                                        <p className="text-gray-900 font-medium">{selectedObject.object_id}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600">Тип</p>
                                        <p className="text-gray-900 font-medium">{selectedObject.object_type}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600">Трубопровод</p>
                                        <p className="text-gray-900 font-medium">{selectedObject.pipeline_id}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600">Год</p>
                                        <p className="text-gray-900 font-medium">{selectedObject.year || 'N/A'}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600">Материал</p>
                                        <p className="text-gray-900 font-medium">{selectedObject.material || 'N/A'}</p>
                                    </div>
                                    <div>
                                        ...
                                        (() => {
                                            ...
                                            <div key={insp.diag_id} className="bg-white rounded-lg p-4">
                                                <div className="flex items-start justify-between mb-2">
                                                    <div>
                                                        <span className="text-gray-900 font-medium">{insp.method}</span>
                                                        <p className="text-gray-600 text-sm">{insp.date}</p>
                                                    </div>
                                                    {insp.ml_label && (
                                                        <span
                                                            className={`px-2 py-1 rounded text-xs font-medium text-gray-900 ${insp.ml_label === 'high'
                                                                ? 'bg-red-500'
