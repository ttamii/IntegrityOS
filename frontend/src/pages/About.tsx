    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div>
                ...
                <p className="text-slate-400">Платформа анализа трубопроводов с ML-классификацией</p>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 card-hover">
                ...
                <div className="space-y-4 text-slate-300">
                    <p>
                        <strong className="text-white">IntegrityOS</strong> - это комплексная система для визуализации,
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-slate-700 rounded-lg p-4 text-center">
                            ...
                            <div className="text-sm text-slate-400 mt-1">Точность модели</div>
                        </div>
                        <div className="bg-slate-700 rounded-lg p-4 text-center">
                            <div className="text-3xl font-bold text-primary-400">11</div>
                            <div className="text-sm text-slate-400 mt-1">Признаков</div>
                        </div>
                        <div className="bg-slate-700 rounded-lg p-4 text-center">
                            <div className="text-3xl font-bold text-primary-400">91</div>
                            <div className="text-sm text-slate-400 mt-1">Дефектов в обучении</div>
                        </div>
                    </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 card-hover">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-slate-400">React компонентов</div>
                    </div>
                </div>
            </div>
        </div>
